...
const ProjectCard = (project) => {
  ...
  return (
    ...
    <a href={url}><TbWorldWww className='h-8 w-8 text-slate-800 hover:text-black duration-300'/></a>
    <a href={github}><FaGithubSquare className='h-8 w-8 text-slate-800 hover:text-black duration-300'/></a>
